<template>
    ...
    <Head title="Training & Development - Coaching Log" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <GrowthTrackerLayout>
            <div class="space-y-6">
                <PageHeader title="Training & Development" description="Manage your training & development"
                    :badge="`0 entries`">
                    <template #actions>
                ...
                <div
                    ...
                    <div class="relative z-10 text-center">
                        <p class="text-neutral-500 dark:text-neutral-400 text-sm">
                            No coaching log entries yet. Start tracking your coaching sessions.
                        </p>
                    </div>
                </div>
...
import { index } from '@/actions/App/Http/Controllers/Tenant/Coach/TrainingLogController';
