...
<head>
    ...
    <title>Per-Session Coaching Agreement</title>
    
    {{-- Template Schema Definition --}}
    {{-- 
    @template-schema
    {
        "template_name": "Per-Session Coaching Agreement",
        ...
        "categories": {
            ...
            "financial_terms": {
                ...
                "description": "Set your per-session fees and payment terms",
                "fields": {
                    "session_fee": {
...
<body>
    ...
    <div class="header">
        <h1>Per-Session Coaching Agreement</h1>
    ...
    <div class="section">
        <div class="section-title">4. Coaching Sessions</div>
        <ul>
            <li><strong>Frequency:</strong> <span class="variable">{{ $session_frequency }}</span></li>
            <li><strong>Duration:</strong> <span class="variable">{{ $session_duration }}</span> minutes per session</li>
            <li><strong>Format:</strong> <span class="variable">{{ $session_format }}</span></li>
            <li><strong>Location:</strong> <span class="variable">{{ $session_location }}</span></li>
            <li><strong>Total Sessions:</strong> <span class="variable">{{ $total_sessions }}</span></li>
        </ul>
    </div>

    <div class="section">
        <div class="section-title">5. Fees and Payment</div>
        <p>The coaching fee is <strong><span class="variable">{{ $session_fee }}</span></strong> per session.</p>
        <p>Payments are due <span class="variable">{{ $payment_terms }}</span>. Missed sessions without 24-hour notice may be charged in full.</p>
    </div>

    <div class="section">
        <div class="section-title">6. Cancellation Policy</div>
        <p>Clients must provide at least <strong>24 hours' notice</strong> to reschedule or cancel a session. Late cancellations may incur the full session fee.</p>
    </div> 
    ...
    <div class="section">
        <div class="section-title">9. Termination of Agreement</div>
        <p>Either party may terminate this agreement with written notice. Outstanding sessions may be refunded or rescheduled by mutual agreement.</p>
    </div>
    ...
    <div class="section">
        <div class="section-title">11. Data Protection & Record Keeping</div>
    ...
    <div class="section">
        <div class="section-title">12. Signatures</div>
